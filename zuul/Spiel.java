...
public class Spiel 
{
    ...
    {
        Raum lichtung, waldstueck, taverne, hexenhaus, dorfplatz, piratenhoehle, geheimgang, keller, gaestezimmer;
        ...
        piratenhoehle = new Raum("in der Piratenhöhle");
        geheimgang = new Raum("in einem Geheimgang");
        keller = new Raum("in einem Keller");
        gaestezimmer = new Raum("im Gästezimmer der Taverne");
